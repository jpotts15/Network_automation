...
#and from https://underdogit.net/2021/08/10/use-netmiko-to-connect-to-multiple-devices-with-a-text-file-100daysofcode/
#intent is for two input files, a config csv and a txt file with list of commands
